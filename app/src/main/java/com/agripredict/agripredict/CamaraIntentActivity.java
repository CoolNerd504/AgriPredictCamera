...
public class CamaraIntentActivity extends Activity {
    ...
    private void openCamera() {
        ...
        CameraManager camerManager = (CameraManager) getSystemService(Context.CAMERA_SERVICE);
        try {
            ...
            camerManager.openCamera(mCameraId, mCameraDeviceStateCallback, null);
    ...
    public Action getIndexApiAction() {
        Thing object = new Thing.Builder()
                .setName("CamaraIntent Page") // TODO: Define a title for the content shown.
